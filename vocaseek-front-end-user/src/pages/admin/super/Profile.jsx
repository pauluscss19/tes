...
function formatRoleLabel(role) {
  return String(role || "Master Admin Platform")
    .replace(/_/g, " ")
        ...
        <div className="pf-password-body">
          ...
          <div className="pf-field">
            ...
            <p className="pf-password-hint">
              Kata sandi harus minimal 8 karakter dan berisi kombinasi huruf serta
              angka.
            </p>
          </div>
        </div>
            ...
            <div className="pf-body">
              ...
              <div className="pf-profile-header">
                ...
                <div className="pf-profile-info">
                  <h2>{savedProfile.fullName || "Super Admin Vokaseek"}</h2>
                  <p>
                    {formatRoleLabel(savedProfile.role)}
