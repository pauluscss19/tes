    ...
    <div className="rl-page user-nav-shell">
      ...
      <main className="rl-main">
        ...
        <div className="rl-card">
            ...
            <div className="rl-job-left">
              ...
              <div>
                ...
                <p className="rl-job-company">
                  {job?.company || "Nama Perusahaan • Lokasi"}
                </p>
              </div>
            </div>

            <div className="rl-badge">{job ? "MAGANG" : "LOWONGAN"}</div>
          </div>
          ...
          <div className="rl-terms">
            ...
            <div className="rl-term">
              ...
              <p>
                Dengan ini Pengguna menyatakan telah membaca, mengerti dan patuh
            ...
            <div className="rl-term">
              <span className="rl-check">✓</span>
              <p>
                Kerahasiaan dan Etika: Wajib menjaga kerahasiaan data
                perusahaan.
              </p>
            </div>
            ...
            <div className="rl-term">
              <span className="rl-check">✓</span>
              <p>
                Pelaksanaan Program & Kepatuhan: Bertanggung jawab atas proses
                program.
              </p>
            </div>
          </div>
        ...
        <div className="rl-buttons">
          ...
          <button
            className="rl-submit"
            onClick={() => navigate("/success-apply")}
          >
            Daftar Lowongan
          </button>
        </div>
