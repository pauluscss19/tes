    ...
    <div className="dm-page user-nav-shell">
      ...
      <main className="dm-main">
        ...
        <div className="dm-card">
          ...
          <div className="dm-file">
            ...
            <div className="dm-file-action">
              <label className="dm-file-btn">
                Ganti file
                <input type="file" hidden onChange={(e) => handleFileChange(e, "ktp")} />
              </label>
            </div>
          </div>
          ...
          <div className="dm-file">
            <div className="dm-file-info">
              <FaFilePdf className="dm-file-icon" />
              <div className="dm-file-name">
                {files.portfolio ? files.portfolio.name : "Otomatis Upload Portfolio"}
              </div>
            </div>
            <div className="dm-file-action">
              <label className="dm-file-btn">
                Ganti file
                <input type="file" hidden onChange={(e) => handleFileChange(e, "portfolio")} />
              </label>
            </div>
          </div>
          ...
          <div className="dm-file">
            <div className="dm-file-info">
              <FaFilePdf className="dm-file-icon" />
              <div className="dm-file-name">
                {files.transkrip ? files.transkrip.name : "Otomatis Upload Transkrip Nilai"}
              </div>
            </div>
            <div className="dm-file-action">
              <label className="dm-file-btn">
                Ganti file
                <input type="file" hidden onChange={(e) => handleFileChange(e, "transkrip")} />
              </label>
            </div>
          </div>
          ...
          <div className="dm-file">
            ...
            <div className="dm-file-action">
              <label className="dm-file-btn">
                Ganti file
                <input type="file" hidden onChange={(e) => handleFileChange(e, "cv")} />
              </label>
            </div>
          </div>
        </div>
        ...
        <div className="dm-next-wrapper">
          ...
          <button className="dm-next" onClick={handleNext}>
            Selanjutnya →
          </button>
        </div>
      </main>
