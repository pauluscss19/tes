...
import { getCandidateDetail } from "../services/talentService";
...
export default function DetailTalent() {
  ...
  const { id }       = useParams(); // ✅ ID lamaran dari URL
  ...
  useEffect(() => {
    ...
    getCandidateDetail(id)
      .then((res) => {
        setData(res.data.data); // { personal, academic, assessment, documents }
        setLoading(false);
      })
      .catch((err) => {
        console.error(err);
  ...
  // Navigasi ke review-dokumen dengan membawa data dokumen
  const goToReviewDokumen = () =>
    navigate(`/talent/${id}/review-dokumen`, {
      state: {
        talent: {
          name:     data?.personal?.name,
          role:     data?.personal?.role,
          photo:    null, // backend belum return foto path
        ...
        <section className="detail-talent__section">
          ...
          <div className="detail-talent__header">
            <div className="detail-talent__header-left">
              <button onClick={() => navigate(-1)} className="detail-talent__back-btn">
                <ArrowLeft size={28} />
              </button>
            ...
            <div className="detail-talent__center-column">
              <div className="detail-talent__card">
                ...
                <div className="detail-talent__card-body-top">
                  ...
                  {/* Skills dari profile — backend belum return, bisa ditambah nanti */}
              ...
              <div className="detail-talent__card">
                ...
                <div className="detail-talent__assessment-action">
                  <button
                    onClick={() => navigate(`/talent/${id}/assessment-review`)}
